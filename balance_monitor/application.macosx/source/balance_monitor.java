...
public class balance_monitor extends PApplet {
...
public void draw() {
  while (port.available() > 0) { //as long as there is data coming from serial port, read it and store it 
    ...
    if (serial != null) {  //if the string is not empty, print the following
      ...
      float deg =PApplet.parseFloat(data[0]);  // Converts and prints float
      deg = deg - 90;
      ...
      float speedL = PApplet.parseFloat(data[1]);
      float speedR = PApplet.parseFloat(data[2]);
      strokeWeight(1);
      line(650,0,650,90);
      strokeWeight(20);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "balance_monitor" };
    if (passedArgs != null) {
